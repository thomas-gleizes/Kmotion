 ...
 *
 * NOTE: manually patched (GET /musics query params + MusicResponseDto.converted)
 * because the committed spec was stale. Regenerate with `pnpm generate:types`
 * against a running server instead of hand-editing.
 */
